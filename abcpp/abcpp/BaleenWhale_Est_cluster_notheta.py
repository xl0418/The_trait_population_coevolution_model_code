...
file_result = dir_path + 'BaleenWhales/notheta/BWest_t%i_h%f.npy' % (int(time_scalar),heri_sqr)
...
prior = [1e-7, 1e-4, 1e-5, 1e-2,nu,nu,100,50,1000,1000]
...
obs_param = DVParamLiang(gamma=1, a=1, K=K,h=np.sqrt(heri_sqr), nu=nu, r=1, theta=meantrait,V00=.1,V01=.1, Vmax=100, inittrait=meantrait, initpop=500,
